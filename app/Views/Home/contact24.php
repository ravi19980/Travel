                ...
                <div class="row">
                        ...
                        <div class="content">
                            <ul>
                                <li>
                                    ...
                                    <div class="info">
                                        <h5>Our Email</h5>
                                        <a href="mailto:info@arcturusconsultingservices.com">info@arcturusconsultingservices.com</a>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon">
                                    ...
                                    <div class="info">
                                        <h5>Address</h5>
                                        <p>
                                            <strong>CANADA</strong><br> &bull;  8 Natronia Trail, Brampton ON L6P 3L9 <br>
                                            &bull;  55 Village Centre Place, Suite 200, Mississauga, ON L4Z1V9<br>
                                            <strong>USA</strong><br> &bull; 30 N Gould St Ste R, Sheridan, WY 82801
                                        </p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="info">
                                        <h5>Phone</h5>
                                        <a href="tel:+4733378901">  +1 613-852-2801</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-8 contact-form-box">
                        <div class="form-box">
                            <h2>Let's talk?</h2>
                            <p>
                            We're delighted to assist you! Have any questions or feedback? Please don't hesitate to reach out or get in touch with us directly. We look forward to connecting with you!
                            </p>
